-module(connector_event_active_report_log).
...
handle_event({active_report_log, MeterId, Msg}, State) ->
    Datetime = ?HELPER:datetime(),
    LogFile = log_util:get_active_report_log_file(Datetime),
    MsgType = ?ACTIVE_REPORT_MSG_TYPE,
